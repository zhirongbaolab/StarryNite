...
function set_image_value(nii_view),
    ...
    if nii_view.nii.hdr.dime.datatype == 128
       imgvalue = [double(img(sag,cor,axi,1)) double(img(sag,cor,axi,2)) double(img(sag,cor,axi,3))];
    ...
    elseif nii_view.nii.hdr.dime.datatype == 511
       R = double(img(sag,cor,axi,1)) * (nii_view.nii.hdr.dime.glmax - ...
		nii_view.nii.hdr.dime.glmin) + nii_view.nii.hdr.dime.glmin;
       G = double(img(sag,cor,axi,2)) * (nii_view.nii.hdr.dime.glmax - ...
		nii_view.nii.hdr.dime.glmin) + nii_view.nii.hdr.dime.glmin;
       B = double(img(sag,cor,axi,3)) * (nii_view.nii.hdr.dime.glmax - ...
		nii_view.nii.hdr.dime.glmin) + nii_view.nii.hdr.dime.glmin;
       imgvalue = [double(img(sag,cor,axi,1)) double(img(sag,cor,axi,2)) double(img(sag,cor,axi,3))];
       set(nii_view.handles.imval,'Value',imgvalue);
       imgvalue = [R G B];
