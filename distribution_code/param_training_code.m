...
hold on
scatter3(FNpoints1(FN1trange,1),FNpoints1(FN1trange,2),FNpoints1(FN1trange,3)*5,'c')
scatter3(FPpoints1(FP1trange,1),FPpoints1(FP1trange,2),FPpoints1(FP1trange,3)*5,'m')
...
%scatter3(TPpoints(selection,1),TPpoints(selection,2),TPpoints(selection,3)*5,'y')
hold on
scatter3(FNpoints2(FN2trange,1),FNpoints2(FN2trange,2),FNpoints2(FN2trange,3)*5,'c')
%stored is just additional 2nd round ones plot both for moment
 scatter3(FPpoints2(FP2trange,1),FPpoints2(FP2trange,2),FPpoints2(FP2trange,3)*5,'m')
 %scatter3(FPpoints1(FP1trange,1),FPpoints1(FP1trange,2),FPpoints1(FP1trange,3)*5,'m')
 axis([0,325,0,220,0,160])
axis('equal')
...
%scatter3(TPpoints(selection,1),TPpoints(selection,2),TPpoints(selection,3)*5,'y')
hold on
scatter3(FNpoints3(FN3trange,1),FNpoints3(FN3trange,2),FNpoints3(FN3trange,3)*5,'c')
scatter3(FPpoints3(FP3trange,1),FPpoints3(FP3trange,2),FPpoints3(FP3trange,3)*5,'m')
  axis([0,325,0,220,0,160])
axis('equal')
