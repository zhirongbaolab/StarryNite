function [ datavector ] =calculateCellPairVectorNondivision_wdiam(nucs,i,nucs2,j,anisotropy)
datavector=[    nucs2.finaldiams(j)/nucs.finaldiams(i),(nucs2.totalGFP(j)/nucs.totalGFP(i)),...
