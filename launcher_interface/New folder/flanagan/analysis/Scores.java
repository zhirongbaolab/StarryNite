...
public class Scores{
    ...
    protected int fileOption = 1;                                                   // type of file option
                                                                                    // option = 1 - text file  (.txt)                                                                        // option = 2 - MS Excel file (.xls)
    ...
    protected double personDeletionPercentage = 0.0;                                // percentage of no responses allowed within a person's responses before the person is deleted
