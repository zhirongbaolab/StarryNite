...
*
*   DATE:	May 2002
*   UPDATE: 20 May 2003, 17 February 2006, 27 July 2007, 4 December 2007, 21 September 2008
*
*   DOCUMENTATION:
...
public class BiCubicSpline{
        ...
        private String subMatrixIndices = " ";                  // String of indices of the submatrices that have called BiCubicSpline if called from higher dimension interpolation
    	...
    	// Set sub-matrix indices - for use with higher dimesion interpolations calling BiCubicSpline
    	...
    	public double interpolate(double xx1, double xx2){
	    	...
	    	for(int i=0; i<this.nPoints; i++){
	        	...
	        	if(!this.derivCalculated)this.csn[i].calcDeriv();
