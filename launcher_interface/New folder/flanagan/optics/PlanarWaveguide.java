...
*
*   Created: March 2006
*   Revised: 29 April 2006, 5-7 July 2008
*
*   DOCUMENTATION:
    ...
    public void plotFittedDispersionCurve(String legend){
        ...
        if(this.numberOfTEmeasurements>0){
            ...
            while(testModes){
                ...
                arraylTE.set(2*pOrder, new Integer(pOrder));
                arraylTE.set(2*pOrder+1, new Integer(pNumber));
        ...
        if(this.numberOfTMmeasurements>0){
            ...
            while(testModes){
                ...
                arraylTM.set(2*pOrder, new Integer(pOrder));
                arraylTM.set(2*pOrder+1, new Integer(pNumber));
