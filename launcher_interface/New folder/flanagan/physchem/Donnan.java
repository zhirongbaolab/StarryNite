   ...
   // Method to add an ionic species to the  Donnan Equilibrium
    ...
    public double calcPotential(){
        ...
        if(this.includeIc){
            ...
            this.diffCapA = this.interfacialCharge/this.diffPotentialA;
            this.diffCapB = this.interfacialCharge/this.diffPotentialB;
            this.donnanCap = this.interfacialCharge/this.donnanPotential;
    ...
    private void unpack(){
        ...
        if(!this.ionophoreSet){
            ...
            if(this.includeIc){
                this.includeIc=false;
                System.out.println("and the interface charge option has been set to neglect the interface charge");
            }
        }
    ...
    public void printToFile(String title){
        ...
        if(this.includeIc){
            ...
            fout.println("C per square metre");
