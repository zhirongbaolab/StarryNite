...
*   DATE:   22 April 2004
*   UPDATE: 21 November 2006, 31 December 2006, 14 April 2007, 19 October 2007,
*           16-29 March 2008, 3 July 2008, 19 September 2008, 28 September 2008
*
*   DOCUMENTATION:
...
public class PsRandom implements Serializable{
   ...
   public double[] rayleighArray (double sigma, int n){
    ...
    public int[] integerArray(int arrayLength, int bottom, int top){
        int[] array = new int[arrayLength];
        for(int i=0; i<arrayLength; i++){
            array[i] = this.nextInteger(bottom - top) + bottom;
        }
        return array;
    }
    ...
    public int[] uniqueIntegerArray(int top){
        ...
        while(test0){
            ...
            if(!found[ii]){
                ...
                found[ii] = true;
                nFound++;
                if(nFound==numberOfIntegers)test0 = false;
            }
        }
        return array;
    }
